...
var EventPayableWithEther = artifacts.require("./EventPayableWithEther.sol");
//var EventPayableWithToken = artifacts.require("./PayableEventToken.sol");
...
const arguments = {
  ...
  deployer.deploy(EventPayableWithEther, 
    arguments.version, arguments.metadata, 
    [addressCT, addressTS, addressOG],
    arguments.saleStart, arguments.saleEnd, 
    arguments.limit, arguments.limitPerHolder, 
